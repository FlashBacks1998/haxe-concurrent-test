...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Haxcontest",35,90,87,eb),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("29",c7,2b,00,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Company Name",4e,48,0d,cb));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Haxcontest",35,90,87,eb));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Haxcontest",35,90,87,eb));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.sample.haxcontest",6c,fe,b9,71));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Haxcontest",35,90,87,eb))
