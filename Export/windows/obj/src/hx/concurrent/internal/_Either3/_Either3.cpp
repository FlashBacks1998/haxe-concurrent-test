...
::hx::concurrent::internal::_Either3::_Either3 _Either3_obj::a( ::Dynamic v)
{
	return ::hx::CreateEnum< _Either3_obj >(HX_("a",61,00,00,00),0,1)->_hx_init(0,v);
}

::hx::concurrent::internal::_Either3::_Either3 _Either3_obj::b( ::Dynamic v)
{
	return ::hx::CreateEnum< _Either3_obj >(HX_("b",62,00,00,00),1,1)->_hx_init(0,v);
}

::hx::concurrent::internal::_Either3::_Either3 _Either3_obj::c( ::Dynamic v)
{
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("hx.concurrent.internal._Either3._Either3",d6,c7,08,bc), ::hx::TCanCast< _Either3_obj >,_Either3_obj_sStaticFields,0,
