...
::hx::concurrent::internal::_Either2::_Either2 _Either2_obj::a( ::Dynamic v)
{
	return ::hx::CreateEnum< _Either2_obj >(HX_("a",61,00,00,00),0,1)->_hx_init(0,v);
}

::hx::concurrent::internal::_Either2::_Either2 _Either2_obj::b( ::Dynamic v)
{
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("hx.concurrent.internal._Either2._Either2",f6,4f,be,fb), ::hx::TCanCast< _Either2_obj >,_Either2_obj_sStaticFields,0,
