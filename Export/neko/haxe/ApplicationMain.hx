...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Haxcontest", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Haxcontest", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Haxcontest";
		app.meta["name"] = "Haxcontest";
		app.meta["packageName"] = "com.sample.haxcontest";
